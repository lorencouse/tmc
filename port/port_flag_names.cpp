...
static const FlagInfo kBank0Flags[] = {
    { "BEGIN", "" },
    { "LV0_CLEAR", "Unused" },
    { "LV1_CLEAR", "Deepwood Shrine cleared" },
    { "LV2_CLEAR", "Cave of Flames cleared" },
    { "LV3_CLEAR", "Fortress of Winds cleared" },
    { "LV4_CLEAR", "Temple of Droplets cleared" },
    { "LV5_CLEAR", "Palace of Winds cleared" },
    { "LV6_CLEAR", "Unused" },
    { "LV7_CLEAR", "Unused" },
    { "LV8_CLEAR", "Unused" },
    { "MACHI_SET_1", "Town state 1 (Big Green Chuchu defeated)" },
    { "MACHI_SET_2", "Town state 2 (Gleerok defeated)" },
    { "MACHI_SET_3", "Town state 3 (Fortress of Winds cleared)" },
    { "MACHI_SET_4", "Town state 4 (Big Octorok defeated)" },
    { "MACHI_SET_5", "Town state 5 (Gyorg Pair defeated)" },
    { "MACHI_SET_6", "Town state 6" },
    { "MACHI_SET_7", "Town state 7" },
    { "MACHI_SET_8", "Town state 8" },
    { "MACHI_MACHIHOKORI", "Sucked dust from carpet" },
    { "START", "Met Zelda" },
    { "EZERO_1ST", "Met Ezlo" },
    { "TABIDACHI", "Talked to Daltus and Smith after award ceremony" },
    { "LV1TARU", "Unused (Deepwood Shrine barrel)" },
    ...
    { "ENTRANCE_OK", "Unused" },
    { "TATSUMAKI", "Mount Crenel vortex activated/used" },
    { "KUMOTATSUMAKI", "Cloud Tops vortex spawned" },
    { "KAITENGIRI", "Spin Attack learned" },
    { "DAIKAITENGIRI", "Great Spin Attack learned" },
    { "GATOTSU", "Dash Attack learned" },
    { "KABUTOWARI", "Down Thrust learned" },
    { "MIZUKAKI_START", "Spoke to Lake Hylia Minish. Library opens (flippers quest begins)." },
    ...
    { "MAROYA_WAKEUP", "Simon's simulation game unlocked/completed" },
    ...
    { "BIN_DOGFOOD", "Obtained dog food bottle / Gave dog food" },
...
static const FlagInfo kBank1Flags[] = {
    { "BEGIN_1", "" },
    ...
    { "HIKYOU_00_T1", "Unused" },
    { "LOST_00_ENTER", "Entered Wind Ruins" },
    ...
    { "MORI_00_HIBI_0", "Unused" },
    { "MORI_00_HIBI_1", "Unused" },
    ...
    { "SOUGEN_06_AKINDO", "Defeated Deku Scrub in Outside Castle with Zelda" },
    ...
    { "CASTLE_00_00", "Unused" },
    { "CASTLE_04_MEZAME", "Award ceremony finished. Disable sleeping cutscene in Hyrule Castle bedroom" },
    ...
    { "KAKERA_TAKARA_J", "Undocumented but referenced in code/scripts" },
    ...
    { "MACHI_01_DEMO", "Zelda gives you the shield / Lolly and Candy Moved in Hyrule Town, Festival" },
    ...
    { "KS_A06", "Kinstone Fusion World Event (KS_A06)" },
...
static const FlagInfo kBank2Flags[] = {
    ...
    { "NPC37_REM_SLEEP", "Rem is sleeping in Rem's Shoe Shop." },
    ...
    { "KHOUSE27_00", "Spoke to Lake Hylia Minish with flippers" },
    ...
    { "KHOUSE52_KINOKO", "Talked to Shoe Shop Minish in Rem's Shoe Shop. Minish-sized door opens in Lon Lon Ranch." },
    ...
    { "CAFE_01_CAP_1", "Ezlo talks about the mushroom in Rem's Shoe Shop." },
    { "KS_A02", "Get charm from Din / Nayru / Farore in red house" },
    { "KS_A09", "undocumented" },
...
static const FlagInfo kBank3Flags[] = {
    { "BEGIN_3", "" },
...
static const FlagInfo kBank4Flags[] = {
    { "BEGIN_4", "" },
...
static const FlagInfo kBank5Flags[] = {
    { "BEGIN_5", "" },
...
static const FlagInfo kBank6Flags[] = {
    { "BEGIN_6", "" },
...
static const FlagInfo kBank7Flags[] = {
    { "BEGIN_7", "" },
...
static const FlagInfo kBank8Flags[] = {
    { "BEGIN_8", "" },
...
static const FlagInfo kBank9Flags[] = {
    { "BEGIN_9", "" },
...
static const FlagInfo kBank10Flags[] = {
    { "BEGIN_10", "" },
...
static const FlagInfo kBank11Flags[] = {
    { "BEGIN_11", "" },
    { "END_11", "" },
};

static const FlagInfo kBank12Flags[] = {
    { "BEGIN_12", "" },
    { "END_12", "" },
};
...
static const BankInfo kBanks[] = {
    { kBank0Flags, sizeof(kBank0Flags) / sizeof(kBank0Flags[0]) },
    { kBank1Flags, sizeof(kBank1Flags) / sizeof(kBank1Flags[0]) },
    { kBank2Flags, sizeof(kBank2Flags) / sizeof(kBank2Flags[0]) },
    { kBank3Flags, sizeof(kBank3Flags) / sizeof(kBank3Flags[0]) },
    { kBank4Flags, sizeof(kBank4Flags) / sizeof(kBank4Flags[0]) },
    { kBank5Flags, sizeof(kBank5Flags) / sizeof(kBank5Flags[0]) },
    { kBank6Flags, sizeof(kBank6Flags) / sizeof(kBank6Flags[0]) },
    { kBank7Flags, sizeof(kBank7Flags) / sizeof(kBank7Flags[0]) },
    { kBank8Flags, sizeof(kBank8Flags) / sizeof(kBank8Flags[0]) },
    { kBank9Flags, sizeof(kBank9Flags) / sizeof(kBank9Flags[0]) },
    { kBank10Flags, sizeof(kBank10Flags) / sizeof(kBank10Flags[0]) },
    { kBank11Flags, sizeof(kBank11Flags) / sizeof(kBank11Flags[0]) },
