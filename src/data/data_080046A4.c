...
const PlayerMacroEntry gPlayerMacroSanctuary[] = {
    { 1, DPAD_UP }, { 120, B_BUTTON }, { 60, 0 }, { PLAYER_MACRO_END, 0 }
};

const PlayerMacroEntry gPlayerMacroBladeBrothers0[] = { { 120, B_BUTTON }, { 60, 0 }, { PLAYER_MACRO_END, 0 } };

const PlayerMacroEntry gPlayerMacroBladeBrothers1[] = {
    { 60, DPAD_RIGHT }, { 4, B_BUTTON }, { 60, 0 }, { PLAYER_MACRO_END, 0 }
};

const PlayerMacroEntry gPlayerMacroBladeBrothers2[] = {
    { 4, DPAD_LEFT }, { 120, A_BUTTON }, { 60, 0 }, { PLAYER_MACRO_END, 0 }
};

const PlayerMacroEntry gPlayerMacroBladeBrothers3[] = { { 1, DPAD_DOWN }, { 4, A_BUTTON }, { 10, 0 },
                                                        { 10, B_BUTTON }, { 60, 0 },       { PLAYER_MACRO_END, 0 } };
...
const PlayerMacroEntry gPlayerMacroBladeBrothers5[] = { { 1, DPAD_LEFT }, { 30, 0 }, { 4, B_BUTTON },        { 60, 0 },
                                                        { 4, B_BUTTON },  { 60, 0 }, { PLAYER_MACRO_END, 0 } };

const PlayerMacroEntry gPlayerMacroBladeBrothers6[] = { { 1, DPAD_LEFT }, { 30, 0 }, { 4, B_BUTTON },        { 60, 0 },
                                                        { 4, B_BUTTON },  { 60, 0 }, { PLAYER_MACRO_END, 0 } };
...
const PlayerMacroEntry gPlayerMacroBladeBrothers7[] = {
    ...
    { 4, 0 },         { 4, B_BUTTON },   { 4, 0 },  { 4, B_BUTTON }, { 30, 0 }, { PLAYER_MACRO_END, 0 }
};
